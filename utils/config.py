...
BASE_PATH = os.path.split(os.path.dirname(os.path.abspath(__file__)))[0]   #/Users/fujunmin/files/python/selfPractise/Test_framework
# print 'base_path:',BASE_PATH
# print 'base_path:',os.path.dirname(os.path.abspath(__file__)) #/Users/fujunmin/files/python/selfPractise/Test_framework/utils
